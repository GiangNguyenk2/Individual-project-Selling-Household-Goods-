                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-7">
                                    <div class="product-content">
                                        ...
                                        <div class="action">
                                            <a class="btn" href="cart?action=add2cart&id=${p.id}"><i class="fa fa-shopping-cart"></i>Add to Cart</a>
                                            <a class="btn" href="cart?action=add2cart&id=${p.id}"><i class="fa fa-shopping-bag"></i>Buy Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
